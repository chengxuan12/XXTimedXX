...
// message in all supported languages
    ath.intl = {
        en_us: {
            //message: '点下面的图标，再点“<strong>%action</strong>”: tap %icon and then <strong>%action</strong>.',
            message: '“<strong>%action</strong>”，更方便使用哦！',
            action: { ios: '添加到主屏幕', android: '添加到主屏幕', windows: '添加到开始' }
        },
